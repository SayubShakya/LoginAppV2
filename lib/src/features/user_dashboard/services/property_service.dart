...
class PropertyService {
  final String _baseUrl = "http://192.168.1.82:5000/api/properties";
  final String _uploadImageUrl = "http://192.168.1.82:5000/api/images/upload-image";
  ...
  Future<List<PropertyTypeModel>> getPropertyTypes({int page = 1, int limit = 50}) async {
    try {
      ...
      final response = await http.get(
        Uri.parse("http://192.168.1.82:5000/api/property-types?page=$page&limit=$limit"),
        headers: headers,
      );
  ...
  Future<List<StatusModel>> getStatuses({int page = 1, int limit = 50}) async {
    try {
      ...
      final headers = await _getHeaders();
      final response = await http.get(
        Uri.parse("http://192.168.1.82:5000/api/statuses?page=$page&limit=$limit"),
        headers: headers,
      );
